...
public class WAMServerOnePlayer {
     ...
     * @throws IOException
     */
    public WAMServerOnePlayer(Socket c, int rows, int cols, int numPlayers) throws IOException {
    ...
    public static void main(String[] args) throws IOException{
        ...
        String welcome = WELCOME + " " + rows + " " + cols + " " + numPlayers + " 1";
        send(welcome, new PrintWriter(c.getOutputStream()));
        System.out.println("Client 1 has been connected.");
        WAMServerOnePlayer gameServer = new WAMServerOnePlayer(c, rows, cols, numPlayers);
    }
}
